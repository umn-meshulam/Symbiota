...
CREATE TABLE `fmchklsttaxalink` (
  ...
  UNIQUE KEY `FK_chklsttaxalink_cid_tid` (`clid`, `tid`), -- for referencechklsttaxalink constraint FK_refchktaxalink_clidtid
...
CREATE TABLE `kmcharheading` (
  ...
  UNIQUE KEY `hid` (`hid`), -- for kmcharheadinglang constraint FK_kmcharheadinglang_hid
...
CREATE TABLE `uploadspectemp` (
  ...
  `occurrenceID` text DEFAULT NULL COMMENT 'UniqueGlobalIdentifier',
  `catalogNumber` varchar(32) DEFAULT NULL,
  `otherCatalogNumbers` varchar(255) DEFAULT NULL,
  `ownerInstitutionCode` varchar(32) DEFAULT NULL,
  ...
  `identificationReferences` text DEFAULT NULL,
  `identificationRemarks` text DEFAULT NULL,
  `identificationQualifier` text DEFAULT NULL COMMENT 'cf, aff, etc',
  `typeStatus` text DEFAULT NULL,
  `recordedBy` text DEFAULT NULL COMMENT 'Collector(s)',
  `recordNumberPrefix` text DEFAULT NULL,
  `recordNumberSuffix` text DEFAULT NULL,
  `recordNumber` text DEFAULT NULL COMMENT 'Collector Number',
  `CollectorFamilyName` text DEFAULT NULL COMMENT 'not DwC',
  `CollectorInitials` text DEFAULT NULL COMMENT 'not DwC',
  `associatedCollectors` text DEFAULT NULL COMMENT 'not DwC',
  `eventDate` date DEFAULT NULL,
  `eventDate2` date DEFAULT NULL,
  `year` int(10) DEFAULT NULL,
  `month` int(10) DEFAULT NULL,
  ...
  `occurrenceRemarks` text DEFAULT NULL COMMENT 'General Notes',
  `informationWithheld` text DEFAULT NULL,
  `dataGeneralizations` text DEFAULT NULL,
  `associatedOccurrences` text DEFAULT NULL,
  ...
  `reproductiveCondition` text DEFAULT NULL COMMENT 'Phenology: flowers, fruit, sterile',
  `cultivationStatus` int(10) DEFAULT NULL COMMENT '0 = wild, 1 = cultivated',
  ...
  `parentLocationID` text DEFAULT NULL,
  ...
  `localitySecurityReason` text DEFAULT NULL,
  `decimalLatitude` double DEFAULT NULL,
  `decimalLongitude` double DEFAULT NULL,
  ...
  `UtmNorthing` text DEFAULT NULL,
  `UtmEasting` text DEFAULT NULL,
  `UtmZoning` text DEFAULT NULL,
  `trsTownship` text DEFAULT NULL,
  `trsRange` text DEFAULT NULL,
  `trsSection` text DEFAULT NULL,
  `trsSectionDetails` text DEFAULT NULL,
  ...
  `minimumElevationInMeters` int(6) DEFAULT NULL,
  `maximumElevationInMeters` int(6) DEFAULT NULL,
  `elevationNumber` text DEFAULT NULL,
  `elevationUnits` text DEFAULT NULL,
  ...
  `genericcolumn1` text DEFAULT NULL,
  `genericcolumn2` text DEFAULT NULL,
  `exsiccatiIdentifier` int(11) DEFAULT NULL,
  `exsiccatiNumber` text DEFAULT NULL,
  `exsiccatiNotes` text DEFAULT NULL,
  `paleoJSON` text DEFAULT NULL,
  `materialSampleJSON` text DEFAULT NULL,
  `modified` datetime DEFAULT NULL COMMENT 'DateLastModified',
  `language` varchar(20) DEFAULT NULL,
  `observeruid` int(11) DEFAULT NULL,
  `recordEnteredBy` text DEFAULT NULL,
  `dateEntered` datetime DEFAULT NULL,
  `duplicateQuantity` int(10) unsigned DEFAULT NULL,
  `labelProject` text DEFAULT NULL,
